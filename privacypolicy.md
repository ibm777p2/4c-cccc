...
We take reasonable administrative, technical, and organizational measures to protect your information from unauthorized access, loss, misuse, or disclosure.  
...
Our App is intended for church members and attendees.  
We do not knowingly collect personal information from children under the age of 13 without parental consent.  
If you believe a child has provided personal data without consent, please contact us so we can remove it.
...
Any changes will be posted within the App or this repository with an updated “Last updated” date.
...
使用本 App 即表示你同意本私隱政策所述嘅資料處理方式。

---

## 1. 關於本教會

4C 基督為中心社區教會係一個以基督為中心、以聖經為根基、由聖靈引導嘅教會群體，致力於門徒訓練、社區外展，並裝備下一代成為基督嘅僕人。  
我哋相信每一個人喺造物主眼中都極其寶貴。
...
> **注意：** 我哋 **不會** 儲存完整信用卡或銀行帳戶資料。所有奉獻均經由第三方安全付款平台處理。

### 2.2 自動收集嘅資料
我哋可能會收集有限嘅技術資料，例如：
- 裝置類型及作業系統  
- App 使用情況（例如瀏覽頁面、使用功能）  
- 錯誤紀錄及效能數據  

以上資料只用於改善 App 嘅穩定性同使用體驗。
...
- 本 App 提供**自願性奉獻**功能  
- 所有奉獻均透過符合業界安全標準嘅第三方付款服務處理  
- 教會不會儲存敏感付款資料  
- 奉獻紀錄只用於收據、內部管理及法律合規用途
...
我哋只會喺以下情況有限度分享資料：
- 與受信任嘅服務供應商（如登入、奉獻、App 託管服務）  
- 因應法律要求或合法請求  
- 為保障教會、用戶或 App 嘅權利及安全  
...
我哋採取合理嘅行政、技術及組織措施，以保護你的資料免受未經授權存取、遺失、濫用或披露。  
然而，任何電子系統都無法保證百分百安全。
...
本 App 主要供教會會眾及參加者使用。  
我哋不會在未經家長或監護人同意下，刻意收集13歲以下兒童嘅個人資料。  
如你認為有相關情況，請聯絡我哋以便跟進處理。
...
我哋可能不時更新本私隱政策。  
任何更改將會於 App 或本 GitHub 儲存庫內公佈，並更新「最後更新」日期。
...
**4C 基督為中心社區教會**  
📍 **地址：** 18381 Lake Chabot Road, Castro Valley, CA 94546  
📞 **電話：** (510) 888-1331  
...
如對本私隱政策或本 App 有任何疑問，歡迎透過以上資料與我哋聯絡。
